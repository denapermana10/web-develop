        ...
        {activeTab === "harga" && (
          <div className="space-y-12 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                { name: "Basic", price: "Rp 5.000.000", s: "website-company-profile", desc: "Sempurna untuk representasi instansi digital awal.", features: ["Website Company Profile 5 Halaman", "Desain Premium Responsif", "Optimasi Kecepatan LCP &lt; 2 detik", "Garansi Perbaikan Bug 3 Bulan", "Domain & Hosting (Tahun Pertama)"] },
                { name: "Professional", price: "Rp 15.000.000", s: "ecommerce", desc: "Cocok untuk toko online &amp; portal media dinamis.", features: ["Website E-Commerce Lengkap", "Integrasi Ongkir &amp; Payment Gateway", "Sistem Database Inventaris Produk", "Garansi Perbaikan Bug 6 Bulan", "Maintenance Server Bulanan (Free 3 Bln)", "Akses Source Code Github Repositori"] },
                { name: "Enterprise", price: "Rp 45.000.000", s: "custom-web-app", desc: "Sistem ERP &amp; CRM internal terintegrasi.", features: ["Sistem Custom CRM &amp; POS Kasir", "Fungsi Multi-User &amp; Role Akses", "Keamanan Enkripsi Database PostgreSQL", "Training Penggunaan Tim (2 Sesi)", "Sertifikasi SSL Keamanan Tinggi", "Hak Kepemilikan Penuh Source Code"] },
